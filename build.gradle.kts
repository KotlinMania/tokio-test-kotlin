...
kotlin {
    ...
    val xcf = XCFramework("TokioTest")

    macosArm64 {
        binaries.framework { baseName = "TokioTest"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TokioTest"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TokioTest"
        flattenPackage = "io.github.kotlinmania.tokiotest"
    }

    android {
        namespace = "io.github.kotlinmania.tokiotest"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tokio-test-kotlin", version.toString())

    pom {
        name.set("tokio-test-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/tokio - Testing utilities for Tokio- and futures-based code")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tokio-test-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tokio-test-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tokio-test-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tokio-test-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTokioTestXCFramework",
    "assembleTokioTestDebugXCFramework",
    "assembleTokioTestReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTokioTestXCFramework",
    "assembleReleaseIosFatFrameworkForTokioTestXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTokioTestXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTokioTestXCFramework",
    "assembleDebugMacosFatFrameworkForTokioTestXCFramework",
    "assembleReleaseMacosFatFrameworkForTokioTestXCFramework",
    "assembleDebugTvosFatFrameworkForTokioTestXCFramework",
    "assembleReleaseTvosFatFrameworkForTokioTestXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTokioTestXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTokioTestXCFramework",
    "assembleDebugWatchosFatFrameworkForTokioTestXCFramework",
    "assembleReleaseWatchosFatFrameworkForTokioTestXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTokioTestXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTokioTestXCFramework",
