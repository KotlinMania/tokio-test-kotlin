...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TokioTest.swiftmodule/`
...
//      `import TokioTest` above would fail at compile time.
//
//   2. The static archive `libTokioTest.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TokioTest" }` and
//      `flattenPackage = "io.github.kotlinmania.tokiotest"` configuration in
...
//      via the `TokioTestLibrary` product.
//
